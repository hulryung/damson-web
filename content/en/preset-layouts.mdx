...
<Callout type="info">
  Preset layouts pair naturally with [session restore](/en/tabs-and-panes#session-restore):
...
Combined with the [GPU renderer](/en/features/gpu-rendering) holding steady under
fast output streams, it's a comfortable cockpit for multi-agent work — and if
you want that taken further, see [Orchard](/en/orchard).
